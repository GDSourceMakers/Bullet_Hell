		...
		if (active)
		{
			...
			switch (aiType)
			{
				...
				case AIType.CatmullRom:
					...
					p0 = originalPos + controlPointsList[CatmullRom.ClampListPos(segmentNumber - 1, controlPointsList.Count)];
					p1 = originalPos + controlPointsList[segmentNumber];
					p2 = originalPos + controlPointsList[CatmullRom.ClampListPos(segmentNumber + 1, controlPointsList.Count)];
					p3 = originalPos + controlPointsList[CatmullRom.ClampListPos(segmentNumber + 2, controlPointsList.Count)];
